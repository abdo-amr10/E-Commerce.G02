...
namespace Presentation
{
    ...
    {
        [HttpGet]
        public async Task<ActionResult<IEnumerable<ProductResultDto>>> GetAllProducts(string? sort)
        {
            var products = await ServiceManger.ProductService.GetAllProductsAsync(sort);
            return Ok(products);
        }
